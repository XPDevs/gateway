...
(function() {
    ...
    const LANG = {
        en: { about:'About', store:'Store', gmail:'Gmail', images:'Images', signIn:'Sign in', searchPlaceholder:'Search Gateway or type a URL', gatewaySearch:'Gateway Search', feelingLucky:"I'm Feeling Lucky", unitedKingdom:'United Kingdom', advertising:'Advertising', business:'Business', howSearchWorks:'How Search works', privacy:'Privacy', terms:'Terms', settings:'Settings', all:'All', books:'Books', showMoreResults:'Show more results', noResultsFound:'No results found', tryDifferentKeywords:'Try different keywords or check your spelling', didYouMean:'Did you mean:', quickAnswer:'Quick Answer', searchingMultipleSources:'Searching multiple sources...', connectionError:'Connection error. Please check your internet and try again.', tagline:'Faster than Google. Same results. No API. No index.', resultsStats:'About {count} results — No API. No index. Faster.', settingsTitle:'Settings', language:'Language', darkMode:'Dark mode', close:'Close', wikipedia:'Wikipedia' },
        es: { about:'Acerca de', store:'Tienda', gmail:'Gmail', images:'Imágenes', signIn:'Iniciar sesión', searchPlaceholder:'Buscar en Gateway o escribe una URL', gatewaySearch:'Buscar con Gateway', feelingLucky:'Voy a tener suerte', unitedKingdom:'Reino Unido', advertising:'Publicidad', business:'Negocios', howSearchWorks:'Cómo funciona la Búsqueda', privacy:'Privacidad', terms:'Términos', settings:'Configuración', all:'Todo', books:'Libros', showMoreResults:'Mostrar más resultados', noResultsFound:'No se encontraron resultados', tryDifferentKeywords:'Prueba con otras palabras o revisa la ortografía', didYouMean:'Quizás quisiste decir:', quickAnswer:'Respuesta rápida', searchingMultipleSources:'Buscando en múltiples fuentes...', connectionError:'Error de conexión. Verifica tu internet e inténtalo de nuevo.', tagline:'Más rápido que Google. Mismos resultados. Sin API. Sin índice.', resultsStats:'Aprox. {count} resultados — Sin API. Sin índice. Más rápido.', settingsTitle:'Configuración', language:'Idioma', darkMode:'Modo oscuro', close:'Cerrar', wikipedia:'Wikipedia' },
        fr: { about:'À propos', store:'Boutique', gmail:'Gmail', images:'Images', signIn:'Connexion', searchPlaceholder:'Rechercher sur Gateway ou saisir une URL', gatewaySearch:'Recherche Gateway', feelingLucky:'J\'ai de la chance', unitedKingdom:'Royaume-Uni', advertising:'Publicité', business:'Entreprises', howSearchWorks:'Fonctionnement de la Recherche', privacy:'Confidentialité', terms:'Conditions', settings:'Paramètres', all:'Tout', books:'Livres', showMoreResults:'Plus de résultats', noResultsFound:'Aucun résultat trouvé', tryDifferentKeywords:'Essayez différents mots-clés ou vérifiez l\'orthographe', didYouMean:'Vouliez-vous dire :', quickAnswer:'Réponse rapide', searchingMultipleSources:'Recherche multi-sources...', connectionError:'Erreur de connexion. Vérifiez votre connexion et réessayez.', tagline:'Plus rapide que Google. Mêmes résultats. Sans API. Sans index.', resultsStats:'Environ {count} résultats — Sans API. Sans index. Plus rapide.', settingsTitle:'Paramètres', language:'Langue', darkMode:'Mode sombre', close:'Fermer', wikipedia:'Wikipédia' },
        de: { about:'Über uns', store:'Store', gmail:'Gmail', images:'Bilder', signIn:'Anmelden', searchPlaceholder:'Gateway durchsuchen oder URL eingeben', gatewaySearch:'Gateway-Suche', feelingLucky:'Auf gut Glück', unitedKingdom:'Vereinigtes Königreich', advertising:'Werbung', business:'Unternehmen', howSearchWorks:'So funktioniert die Suche', privacy:'Datenschutz', terms:'AGB', settings:'Einstellungen', all:'Alle', books:'Bücher', showMoreResults:'Weitere Ergebnisse', noResultsFound:'Keine Ergebnisse gefunden', tryDifferentKeywords:'Versuchen Sie andere Suchbegriffe oder überprüfen Sie die Rechtschreibung', didYouMean:'Meinten Sie:', quickAnswer:'Kurze Antwort', searchingMultipleSources:'Durchsuche mehrere Quellen...', connectionError:'Verbindungsfehler. Bitte Internet prüfen und erneut versuchen.', tagline:'Schneller als Google. Gleiche Ergebnisse. Ohne API. Ohne Index.', resultsStats:'Ca. {count} Ergebnisse — Ohne API. Ohne Index. Schneller.', settingsTitle:'Einstellungen', language:'Sprache', darkMode:'Dunkelmodus', close:'Schließen', wikipedia:'Wikipedia' },
        it: { about:'Informazioni', store:'Store', gmail:'Gmail', images:'Immagini', signIn:'Accedi', searchPlaceholder:'Cerca su Gateway o digita un URL', gatewaySearch:'Cerca con Gateway', feelingLucky:'Mi sento fortunato', unitedKingdom:'Regno Unito', advertising:'Pubblicità', business:'Business', howSearchWorks:'Come funziona la Ricerca', privacy:'Privacy', terms:'Termini', settings:'Impostazioni', all:'Tutto', books:'Libri', showMoreResults:'Mostra altri risultati', noResultsFound:'Nessun risultato trovato', tryDifferentKeywords:'Prova con parole diverse o controlla l\'ortografia', didYouMean:'Forse cercavi:', quickAnswer:'Risposta rapida', searchingMultipleSources:'Ricerca in più fonti...', connectionError:'Errore di connessione. Controlla la connessione e riprova.', tagline:'Più veloce di Google. Stessi risultati. Senza API. Senza indice.', resultsStats:'Circa {count} risultati — Senza API. Senza indice. Più veloce.', settingsTitle:'Impostazioni', language:'Lingua', darkMode:'Modalità scura', close:'Chiudi', wikipedia:'Wikipedia' },
        pt: { about:'Sobre', store:'Store', gmail:'Gmail', images:'Imagens', signIn:'Fazer login', searchPlaceholder:'Pesquisar Gateway ou digitar URL', gatewaySearch:'Pesquisa Gateway', feelingLucky:'Estou com sorte', unitedKingdom:'Reino Unido', advertising:'Publicidade', business:'Negócios', howSearchWorks:'Como funciona a Pesquisa', privacy:'Privacidade', terms:'Termos', settings:'Configurações', all:'Tudo', books:'Livros', showMoreResults:'Mostrar mais resultados', noResultsFound:'Nenhum resultado encontrado', tryDifferentKeywords:'Tente palavras-chave diferentes ou verifique a ortografia', didYouMean:'Você quis dizer:', quickAnswer:'Resposta rápida', searchingMultipleSources:'Pesquisando em múltiplas fontes...', connectionError:'Erro de conexão. Verifique sua internet e tente novamente.', tagline:'Mais rápido que o Google. Mesmos resultados. Sem API. Sem índice.', resultsStats:'Aprox. {count} resultados — Sem API. Sem índice. Mais rápido.', settingsTitle:'Configurações', language:'Idioma', darkMode:'Modo escuro', close:'Fechar', wikipedia:'Wikipédia' },
        ru: { about:'О нас', store:'Магазин', gmail:'Gmail', images:'Картинки', signIn:'Войти', searchPlaceholder:'Поиск в Gateway или введите URL', gatewaySearch:'Поиск Gateway', feelingLucky:'Мне повезёт', unitedKingdom:'Великобритания', advertising:'Реклама', business:'Бизнес', howSearchWorks:'Как работает поиск', privacy:'Конфиденциальность', terms:'Условия', settings:'Настройки', all:'Все', books:'Книги', showMoreResults:'Показать больше', noResultsFound:'Ничего не найдено', tryDifferentKeywords:'Попробуйте другие слова или проверьте орфографию', didYouMean:'Возможно, вы имели в виду:', quickAnswer:'Быстрый ответ', searchingMultipleSources:'Поиск по нескольким источникам...', connectionError:'Ошибка подключения. Проверьте интернет и повторите попытку.', tagline:'Быстрее Google. Те же результаты. Без API. Без индекса.', resultsStats:'Примерно {count} результатов — Без API. Без индекса. Быстрее.', settingsTitle:'Настройки', language:'Язык', darkMode:'Тёмная тема', close:'Закрыть', wikipedia:'Википедия' },
        ja: { about:'概要', store:'ストア', gmail:'Gmail', images:'画像', signIn:'ログイン', searchPlaceholder:'Gatewayを検索、またはURLを入力', gatewaySearch:'Gateway検索', feelingLucky:'I\'m Feeling Lucky', unitedKingdom:'イギリス', advertising:'広告', business:'ビジネス', howSearchWorks:'検索の仕組み', privacy:'プライバシー', terms:'利用規約', settings:'設定', all:'すべて', books:'書籍', showMoreResults:'さらに表示', noResultsFound:'結果が見つかりませんでした', tryDifferentKeywords:'別のキーワードを試すか、スペルを確認してください', didYouMean:'もしかして:', quickAnswer:'クイックアンサー', searchingMultipleSources:'複数のソースを検索中...', connectionError:'接続エラーです。インターネット接続を確認してもう一度お試しください。', tagline:'Googleより高速。同じ結果。API不要。インデックス不要。', resultsStats:'約{count}件 — API不要。インデックス不要。より高速。', settingsTitle:'設定', language:'言語', darkMode:'ダークモード', close:'閉じる', wikipedia:'ウィキペディア' },
        'zh-CN': { about:'关于', store:'商店', gmail:'Gmail', images:'图片', signIn:'登录', searchPlaceholder:'搜索 Gateway 或输入网址', gatewaySearch:'Gateway 搜索', feelingLucky:'手气不错', unitedKingdom:'英国', advertising:'广告', business:'商务', howSearchWorks:'搜索工作原理', privacy:'隐私', terms:'条款', settings:'设置', all:'全部', books:'图书', showMoreResults:'显示更多结果', noResultsFound:'未找到结果', tryDifferentKeywords:'尝试不同的关键词或检查拼写', didYouMean:'您是不是要找：', quickAnswer:'快速解答', searchingMultipleSources:'正在搜索多个来源...', connectionError:'连接错误。请检查网络后重试。', tagline:'比谷歌更快。相同结果。无需API。无需索引。', resultsStats:'约{count}条结果 — 无需API。无需索引。更快。', settingsTitle:'设置', language:'语言', darkMode:'深色模式', close:'关闭', wikipedia:'维基百科' },
        'zh-TW': { about:'關於', store:'商店', gmail:'Gmail', images:'圖片', signIn:'登入', searchPlaceholder:'搜尋 Gateway 或輸入網址', gatewaySearch:'Gateway 搜尋', feelingLucky:'好手氣', unitedKingdom:'英國', advertising:'廣告', business:'商務', howSearchWorks:'搜尋運作方式', privacy:'隱私權', terms:'條款', settings:'設定', all:'全部', books:'圖書', showMoreResults:'顯示更多結果', noResultsFound:'找不到結果', tryDifferentKeywords:'請嘗試不同的關鍵字或檢查拼寫', didYouMean:'您是不是要找：', quickAnswer:'快速解答', searchingMultipleSources:'正在搜尋多個來源...', connectionError:'連線錯誤。請檢查網路後重試。', tagline:'比 Google 更快。相同結果。無需 API。無需索引。', resultsStats:'約{count}項結果 — 無需 API。無需索引。更快。', settingsTitle:'設定', language:'語言', darkMode:'深色模式', close:'關閉', wikipedia:'維基百科' },
        ko: { about:'정보', store:'스토어', gmail:'Gmail', images:'이미지', signIn:'로그인', searchPlaceholder:'Gateway 검색 또는 URL 입력', gatewaySearch:'Gateway 검색', feelingLucky:'행운을 빌어요', unitedKingdom:'영국', advertising:'광고', business:'비즈니스', howSearchWorks:'검색 작동 방식', privacy:'개인정보', terms:'약관', settings:'설정', all:'전체', books:'도서', showMoreResults:'더 많은 결과 보기', noResultsFound:'검색 결과가 없습니다', tryDifferentKeywords:'다른 키워드를 시도하거나 철자를 확인하세요', didYouMean:'혹시 찾으시는 것이:', quickAnswer:'빠른 답변', searchingMultipleSources:'여러 소스 검색 중...', connectionError:'연결 오류입니다. 인터넷을 확인하고 다시 시도하세요.', tagline:'Google보다 빠름. 동일한 결과. API 불필요. 인덱스 불필요.', resultsStats:'약 {count}개 결과 — API 불필요. 인덱스 불필요. 더 빠름.', settingsTitle:'설정', language:'언어', darkMode:'다크 모드', close:'닫기', wikipedia:'위키백과' },
        ar: { about:'حول', store:'متجر', gmail:'جيميل', images:'صور', signIn:'تسجيل الدخول', searchPlaceholder:'ابحث في Gateway أو أدخل رابطاً', gatewaySearch:'بحث Gateway', feelingLucky:'أنا محظوظ', unitedKingdom:'المملكة المتحدة', advertising:'إعلانات', business:'أعمال', howSearchWorks:'كيف يعمل البحث', privacy:'خصوصية', terms:'الشروط', settings:'إعدادات', all:'الكل', books:'كتب', showMoreResults:'عرض المزيد من النتائج', noResultsFound:'لم يتم العثور على نتائج', tryDifferentKeywords:'جرّب كلمات مختلفة أو تحقق من الإملاء', didYouMean:'هل تقصد:', quickAnswer:'إجابة سريعة', searchingMultipleSources:'جاري البحث في مصادر متعددة...', connectionError:'خطأ في الاتصال. تحقق من اتصالك بالإنترنت وحاول مرة أخرى.', tagline:'أسرع من Google. نفس النتائج. بدون API. بدون فهرس.', resultsStats:'حوالي {count} نتيجة — بدون API. بدون فهرس. أسرع.', settingsTitle:'الإعدادات', language:'اللغة', darkMode:'الوضع الداكن', close:'إغلاق', wikipedia:'ويكيبيديا' },
        hi: { about:'बारे में', store:'स्टोर', gmail:'जीमेल', images:'चित्र', signIn:'साइन इन', searchPlaceholder:'Gateway में खोजें या URL टाइप करें', gatewaySearch:'Gateway खोज', feelingLucky:'मैं भाग्यशाली हूँ', unitedKingdom:'यूनाइटेड किंगडम', advertising:'विज्ञापन', business:'व्यवसाय', howSearchWorks:'खोज कैसे काम करती है', privacy:'गोपनीयता', terms:'शर्तें', settings:'सेटिंग्स', all:'सभी', books:'पुस्तकें', showMoreResults:'और परिणाम दिखाएँ', noResultsFound:'कोई परिणाम नहीं मिला', tryDifferentKeywords:'अलग कीवर्ड आज़माएँ या वर्तनी जाँचें', didYouMean:'क्या आप यह कहना चाह रहे थे:', quickAnswer:'त्वरित उत्तर', searchingMultipleSources:'कई स्रोतों में खोज रहे हैं...', connectionError:'कनेक्शन त्रुटि। कृपया अपना इंटरनेट जाँचें और पुनः प्रयास करें।', tagline:'Google से तेज़। वही परिणाम। कोई API नहीं। कोई इंडेक्स नहीं।', resultsStats:'लगभग {count} परिणाम — कोई API नहीं। कोई इंडेक्स नहीं। तेज़।', settingsTitle:'सेटिंग्स', language:'भाषा', darkMode:'डार्क मोड', close:'बंद करें', wikipedia:'विकिपीडिया' },
        bn: { about:'সম্পর্কে', store:'স্টোর', gmail:'জিমেইল', images:'ছবি', signIn:'সাইন ইন', searchPlaceholder:'Gateway-এ অনুসন্ধান করুন বা URL লিখুন', gatewaySearch:'Gateway অনুসন্ধান', feelingLucky:'আমি ভাগ্যবান', unitedKingdom:'যুক্তরাজ্য', advertising:'বিজ্ঞাপন', business:'ব্যবসা', howSearchWorks:'কিভাবে অনুসন্ধান কাজ করে', privacy:'গোপনীয়তা', terms:'শর্তাবলী', settings:'সেটিংস', all:'সব', books:'বই', showMoreResults:'আরও ফলাফল দেখান', noResultsFound:'কোনো ফলাফল পাওয়া যায়নি', tryDifferentKeywords:'ভিন্ন শব্দ ব্যবহার করুন বা বানান পরীক্ষা করুন', didYouMean:'আপনি কি বোঝাতে চেয়েছেন:', quickAnswer:'দ্রুত উত্তর', searchingMultipleSources:'একাধিক উৎসে অনুসন্ধান করা হচ্ছে...', connectionError:'সংযোগ ত্রুটি। আপনার ইন্টারনেট পরীক্ষা করে আবার চেষ্টা করুন।', tagline:'Google-এর চেয়ে দ্রুত। একই ফলাফল। কোনো API নেই। কোনো ইনডেক্স নেই।', resultsStats:'প্রায় {count}টি ফলাফল — কোনো API নেই। কোনো ইনডেক্স নেই। দ্রুততর।', settingsTitle:'সেটিংস', language:'ভাষা', darkMode:'ডার্ক মোড', close:'বন্ধ করুন', wikipedia:'উইকিপিডিয়া' },
        tr: { about:'Hakkında', store:'Store', gmail:'Gmail', images:'Görseller', signIn:'Oturum aç', searchPlaceholder:'Gateway\'de ara veya URL yaz', gatewaySearch:'Gateway Arama', feelingLucky:'Şanslıyım', unitedKingdom:'Birleşik Krallık', advertising:'Reklam', business:'İşletme', howSearchWorks:'Arama nasıl çalışır', privacy:'Gizlilik', terms:'Şartlar', settings:'Ayarlar', all:'Tümü', books:'Kitaplar', showMoreResults:'Daha fazla sonuç göster', noResultsFound:'Sonuç bulunamadı', tryDifferentKeywords:'Farklı anahtar kelimeler deneyin veya yazımı kontrol edin', didYouMean:'Bunu mu demek istediniz:', quickAnswer:'Hızlı Cevap', searchingMultipleSources:'Birden çok kaynak taranıyor...', connectionError:'Bağlantı hatası. Lütfen internetinizi kontrol edip tekrar deneyin.', tagline:'Google\'dan daha hızlı. Aynı sonuçlar. API yok. Dizin yok.', resultsStats:'Yaklaşık {count} sonuç — API yok. Dizin yok. Daha hızlı.', settingsTitle:'Ayarlar', language:'Dil', darkMode:'Karanlık mod', close:'Kapat', wikipedia:'Vikipedi' },
        nl: { about:'Over ons', store:'Winkel', gmail:'Gmail', images:'Afbeeldingen', signIn:'Inloggen', searchPlaceholder:'Zoek op Gateway of typ een URL', gatewaySearch:'Gateway Zoeken', feelingLucky:'Gelukzoeker', unitedKingdom:'Verenigd Koninkrijk', advertising:'Adverteren', business:'Zakelijk', howSearchWorks:'Hoe zoeken werkt', privacy:'Privacy', terms:'Voorwaarden', settings:'Instellingen', all:'Alles', books:'Boeken', showMoreResults:'Meer resultaten', noResultsFound:'Geen resultaten gevonden', tryDifferentKeywords:'Probeer andere zoekwoorden of controleer de spelling', didYouMean:'Bedoelde u:', quickAnswer:'Snel antwoord', searchingMultipleSources:'Meerdere bronnen doorzoeken...', connectionError:'Verbindingsfout. Controleer uw internet en probeer het opnieuw.', tagline:'Sneller dan Google. Zelfde resultaten. Geen API. Geen index.', resultsStats:'Ongeveer {count} resultaten — Geen API. Geen index. Sneller.', settingsTitle:'Instellingen', language:'Taal', darkMode:'Donkere modus', close:'Sluiten', wikipedia:'Wikipedia' },
        pl: { about:'O nas', store:'Sklep', gmail:'Gmail', images:'Obrazy', signIn:'Zaloguj się', searchPlaceholder:'Szukaj w Gateway lub wpisz URL', gatewaySearch:'Szukaj w Gateway', feelingLucky:'Szczęściarz', unitedKingdom:'Wielka Brytania', advertising:'Reklama', business:'Firmy', howSearchWorks:'Jak działa wyszukiwanie', privacy:'Prywatność', terms:'Warunki', settings:'Ustawienia', all:'Wszystkie', books:'Książki', showMoreResults:'Pokaż więcej wyników', noResultsFound:'Brak wyników', tryDifferentKeywords:'Spróbuj innych słów kluczowych lub sprawdź pisownię', didYouMean:'Czy chodziło Ci o:', quickAnswer:'Szybka odpowiedź', searchingMultipleSources:'Przeszukiwanie wielu źródeł...', connectionError:'Błąd połączenia. Sprawdź internet i spróbuj ponownie.', tagline:'Szybsze niż Google. Te same wyniki. Bez API. Bez indeksu.', resultsStats:'Około {count} wyników — Bez API. Bez indeksu. Szybciej.', settingsTitle:'Ustawienia', language:'Język', darkMode:'Tryb ciemny', close:'Zamknij', wikipedia:'Wikipedia' },
        sv: { about:'Om', store:'Butik', gmail:'Gmail', images:'Bilder', signIn:'Logga in', searchPlaceholder:'Sök på Gateway eller skriv en URL', gatewaySearch:'Gateway-sökning', feelingLucky:'Jag känner mig turlig', unitedKingdom:'Storbritannien', advertising:'Annonsering', business:'Företag', howSearchWorks:'Så fungerar sökning', privacy:'Integritet', terms:'Villkor', settings:'Inställningar', all:'Alla', books:'Böcker', showMoreResults:'Visa fler resultat', noResultsFound:'Inga resultat hittades', tryDifferentKeywords:'Prova andra sökord eller kontrollera stavningen', didYouMean:'Menade du:', quickAnswer:'Snabbt svar', searchingMultipleSources:'Söker i flera källor...', connectionError:'Anslutningsfel. Kontrollera din internetanslutning och försök igen.', tagline:'Snabbare än Google. Samma resultat. Inget API. Inget index.', resultsStats:'Ungefär {count} resultat — Inget API. Inget index. Snabbare.', settingsTitle:'Inställningar', language:'Språk', darkMode:'Mörkt läge', close:'Stäng', wikipedia:'Wikipedia' },
        da: { about:'Om', store:'Butik', gmail:'Gmail', images:'Billeder', signIn:'Log ind', searchPlaceholder:'Søg på Gateway eller skriv en URL', gatewaySearch:'Gateway-søgning', feelingLucky:'Jeg er heldig', unitedKingdom:'Storbritannien', advertising:'Annoncering', business:'Virksomhed', howSearchWorks:'Sådan fungerer søgning', privacy:'Privatliv', terms:'Vilkår', settings:'Indstillinger', all:'Alle', books:'Bøger', showMoreResults:'Vis flere resultater', noResultsFound:'Ingen resultater fundet', tryDifferentKeywords:'Prøv andre søgeord eller tjek stavningen', didYouMean:'Mente du:', quickAnswer:'Hurtigt svar', searchingMultipleSources:'Søger i flere kilder...', connectionError:'Forbindelsesfejl. Tjek din internetforbindelse og prøv igen.', tagline:'Hurtigere end Google. Samme resultater. Intet API. Intet indeks.', resultsStats:'Ca. {count} resultater — Intet API. Intet indeks. Hurtigere.', settingsTitle:'Indstillinger', language:'Sprog', darkMode:'Mørk tilstand', close:'Luk', wikipedia:'Wikipedia' },
        fi: { about:'Tietoja', store:'Kauppa', gmail:'Gmail', images:'Kuvat', signIn:'Kirjaudu sisään', searchPlaceholder:'Hae Gatewaysta tai kirjoita URL', gatewaySearch:'Gateway-haku', feelingLucky:'Minulla on tuuria', unitedKingdom:'Yhdistynyt kuningaskunta', advertising:'Mainonta', business:'Yritykset', howSearchWorks:'Näin haku toimii', privacy:'Yksityisyys', terms:'Ehdot', settings:'Asetukset', all:'Kaikki', books:'Kirjat', showMoreResults:'Näytä lisää tuloksia', noResultsFound:'Ei tuloksia', tryDifferentKeywords:'Kokeile eri hakusanoja tai tarkista oikeinkirjoitus', didYouMean:'Tarkoititko:', quickAnswer:'Pikavastaus', searchingMultipleSources:'Haetaan useista lähteistä...', connectionError:'Yhteysvirhe. Tarkista internetyhteys ja yritä uudelleen.', tagline:'Nopeampi kuin Google. Samat tulokset. Ei APIa. Ei indeksiä.', resultsStats:'Noin {count} tulosta — Ei APIa. Ei indeksiä. Nopeampi.', settingsTitle:'Asetukset', language:'Kieli', darkMode:'Tumma tila', close:'Sulje', wikipedia:'Wikipedia' },
        no: { about:'Om', store:'Butikk', gmail:'Gmail', images:'Bilder', signIn:'Logg inn', searchPlaceholder:'Søk på Gateway eller skriv en URL', gatewaySearch:'Gateway-søk', feelingLucky:'Jeg er heldig', unitedKingdom:'Storbritannia', advertising:'Annonsering', business:'Bedrifter', howSearchWorks:'Slik fungerer søk', privacy:'Personvern', terms:'Vilkår', settings:'Innstillinger', all:'Alle', books:'Bøker', showMoreResults:'Vis flere resultater', noResultsFound:'Ingen resultater funnet', tryDifferentKeywords:'Prøv andre søkeord eller sjekk stavemåten', didYouMean:'Mente du:', quickAnswer:'Hurtig svar', searchingMultipleSources:'Søker i flere kilder...', connectionError:'Tilkoblingsfeil. Sjekk internettilkoblingen og prøv igjen.', tagline:'Raskere enn Google. Samme resultater. Uten API. Uten indeks.', resultsStats:'Omtrent {count} resultater — Uten API. Uten indeks. Raskere.', settingsTitle:'Innstillinger', language:'Språk', darkMode:'Mørk modus', close:'Lukk', wikipedia:'Wikipedia' },
        cs: { about:'O nás', store:'Obchod', gmail:'Gmail', images:'Obrázky', signIn:'Přihlásit se', searchPlaceholder:'Hledat na Gateway nebo zadat URL', gatewaySearch:'Hledat Gateway', feelingLucky:'Chci mít štěstí', unitedKingdom:'Spojené království', advertising:'Reklama', business:'Firmy', howSearchWorks:'Jak vyhledávání funguje', privacy:'Soukromí', terms:'Smluvní podmínky', settings:'Nastavení', all:'Vše', books:'Knihy', showMoreResults:'Zobrazit více výsledků', noResultsFound:'Nebyly nalezeny žádné výsledky', tryDifferentKeywords:'Zkuste jiná klíčová slova nebo zkontrolujte pravopis', didYouMean:'Mysleli jste:', quickAnswer:'Rychlá odpověď', searchingMultipleSources:'Vyhledávání ve více zdrojích...', connectionError:'Chyba připojení. Zkontrolujte připojení k internetu a zkuste to znovu.', tagline:'Rychlejší než Google. Stejné výsledky. Bez API. Bez indexu.', resultsStats:'Přibližně {count} výsledků — Bez API. Bez indexu. Rychleji.', settingsTitle:'Nastavení', language:'Jazyk', darkMode:'Tmavý režim', close:'Zavřít', wikipedia:'Wikipedie' },
        ro: { about:'Despre', store:'Magazin', gmail:'Gmail', images:'Imagini', signIn:'Autentificare', searchPlaceholder:'Căutați pe Gateway sau introduceți o adresă URL', gatewaySearch:'Căutare Gateway', feelingLucky:'Norocos', unitedKingdom:'Regatul Unit', advertising:'Publicitate', business:'Afaceri', howSearchWorks:'Cum funcționează Căutarea', privacy:'Confidențialitate', terms:'Termeni', settings:'Setări', all:'Toate', books:'Cărți', showMoreResults:'Arată mai multe rezultate', noResultsFound:'Nu s-au găsit rezultate', tryDifferentKeywords:'Încercați alte cuvinte cheie sau verificați ortografia', didYouMean:'Poate ați vrut să spuneți:', quickAnswer:'Răspuns rapid', searchingMultipleSources:'Se caută în mai multe surse...', connectionError:'Eroare de conexiune. Verificați internetul și încercați din nou.', tagline:'Mai rapid decât Google. Aceleași rezultate. Fără API. Fără index.', resultsStats:'Aproximativ {count} rezultate — Fără API. Fără index. Mai rapid.', settingsTitle:'Setări', language:'Limbă', darkMode:'Mod întunecat', close:'Închide', wikipedia:'Wikipedia' },
        hu: { about:'Névjegy', store:'Áruház', gmail:'Gmail', images:'Képek', signIn:'Bejelentkezés', searchPlaceholder:'Keresés a Gatewayben vagy URL megadása', gatewaySearch:'Gateway-keresés', feelingLucky:'Szerencsém van', unitedKingdom:'Egyesült Királyság', advertising:'Hirdetés', business:'Vállalkozások', howSearchWorks:'Hogyan működik a keresés', privacy:'Adatvédelem', terms:'Feltételek', settings:'Beállítások', all:'Összes', books:'Könyvek', showMoreResults:'Több találat mutatása', noResultsFound:'Nincs találat', tryDifferentKeywords:'Próbáljon más kulcsszavakat vagy ellenőrizze a helyesírást', didYouMean:'Esetleg erre gondolt:', quickAnswer:'Gyors válasz', searchingMultipleSources:'Keresés több forrásban...', connectionError:'Kapcsolódási hiba. Ellenőrizze az internetkapcsolatot és próbálja újra.', tagline:'Gyorsabb, mint a Google. Ugyanazok az eredmények. Nincs API. Nincs index.', resultsStats:'Kb. {count} találat — Nincs API. Nincs index. Gyorsabb.', settingsTitle:'Beállítások', language:'Nyelv', darkMode:'Sötét mód', close:'Bezár', wikipedia:'Wikipédia' },
        el: { about:'Σχετικά', store:'Κατάστημα', gmail:'Gmail', images:'Εικόνες', signIn:'Σύνδεση', searchPlaceholder:'Αναζήτηση στο Gateway ή πληκτρολογήστε URL', gatewaySearch:'Αναζήτηση Gateway', feelingLucky:'Τυχερός', unitedKingdom:'Ηνωμένο Βασίλειο', advertising:'Διαφήμιση', business:'Επιχειρήσεις', howSearchWorks:'Πώς λειτουργεί η Αναζήτηση', privacy:'Απόρρητο', terms:'Όροι', settings:'Ρυθμίσεις', all:'Όλα', books:'Βιβλία', showMoreResults:'Εμφάνιση περισσότερων αποτελεσμάτων', noResultsFound:'Δεν βρέθηκαν αποτελέσματα', tryDifferentKeywords:'Δοκιμάστε διαφορετικές λέξεις-κλειδιά ή ελέγξτε την ορθογραφία', didYouMean:'Μήπως εννοείτε:', quickAnswer:'Γρήγορη απάντηση', searchingMultipleSources:'Αναζήτηση σε πολλαπλές πηγές...', connectionError:'Σφάλμα σύνδεσης. Ελέγξτε το διαδίκτυο και δοκιμάστε ξανά.', tagline:'Ταχύτερο από το Google. Ίδια αποτελέσματα. Χωρίς API. Χωρίς ευρετήριο.', resultsStats:'Περίπου {count} αποτελέσματα — Χωρίς API. Χωρίς ευρετήριο. Ταχύτερο.', settingsTitle:'Ρυθμίσεις', language:'Γλώσσα', darkMode:'Σκοτεινή λειτουργία', close:'Κλείσιμο', wikipedia:'Βικιπαίδεια' }
    };
    ...
    let _lang = localStorage.getItem('gw-lang') || 'en';
    if (!LANG[_lang]) _lang = 'en';
    ...
    const SOURCE_TABS = { all: null, images: 'image', books: 'book' };
    ...
    function resultBadge(r) {
        ...
        if (r.resultType === 'book') return '<span class="badge book">B</span>';
    ...
    window._gwRender = function() {
        ...
        if (answerArea) {
            if (activeTab === 'all' && (lastQuery.includes('?') || lastQuery.split(' ').length > 3)) {
                const top = filtered.find(r => (r.resultType === 'wiki' || r.source === 'special') && r.extract && r.extract.length > 60);
                if (top) {
                    const ans = top.extract.split('. ').slice(0, 2).join('. ') + '.';
                    answerArea.innerHTML = `
                        <div class="answer-box">
                            ...
                            <div class="answer-source">
                                ...
                                <a href="${top.url}" target="_self">${top.title}</a>
                            </div>
                        </div>`;
